...
def get_args_parser():
    ...
    parser.add_argument('--finetune', default='/home/kroknes/myfiles/mae/demo/mae_visualize_vit_large.pth', type=str,
    ...
    parser.add_argument('--data_path', default='/home/kroknes/complete_processed_npy', type=str,
                        help='dataset path')    
...
def main(args):
    ...
    if args.finetune and not args.eval:
        checkpoint_path = '/home/kroknes/myfiles/mae/demo/mae_visualize_vit_large.pth'
